...
MEDIA_MAP = {
    ...
    'fnnews': '파이낸셜뉴스', 'ajunews': '아주경제', 'kmib': '국민일보'
}
...
st.markdown("""
    ...
    .news-item { padding: 8px 0; border-bottom: 1px solid #f2f2f2; display: flex; align-items: center; gap: 12px; }
    .media-tag { 
    ...
    .title-link { font-size: 1rem; font-weight: 500; color: #333; text-decoration: none; line-height: 1.5; }
...
for kw in keywords:
    ...
    with col1:
        ...
        for item in items:
            ...
            media_display = MEDIA_MAP.get(eng_id, "뉴스")
...
st.sidebar.caption("실시간 미디어 모니터링 v3.0 (Minimal)")
